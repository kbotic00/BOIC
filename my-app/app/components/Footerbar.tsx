    ...
    return (
        ...
        <div className="flex flex-col md:gap-10 mb-10 md:flex-row md:justify-around items-center justify-center gap-8 p-4">
          ...
          <div className="flex pl-12 flex-row md:flex-col w-60 md:w-auto ">
            <Image src="/frame 147.png" alt="" width={28} height={28} className="hover:text-gray-400 pr-22"></Image>
            <Image src="/frame 148.png" alt="" width={28} height={28} className="hover:text-gray-400"></Image>
            <Image src="/frame 151.png" alt="" width={28} height={28} className="hover:text-gray-400"></Image>
            <Image src="/frame 152.png" alt="" width={28} height={28} className="hover:text-gray-400"></Image>
